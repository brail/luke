      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Carica file per importare dati nel sistema
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Esporta dati dal sistema in formato JSON
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
            ...
            <div className="space-y-3 text-sm text-gray-600">
              <div>
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>
                    <strong>JSON:</strong> Formato nativo per configurazioni e
                    dati strutturati
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                  ...
                  <li>
                    Le password e credenziali sensibili sono sempre cifrate
                  </li>
