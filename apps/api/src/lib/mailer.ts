...
const LOGO_TD =
  ...
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 629.54 628.34" width="72" height="72" fill="#ffffff" style="position:absolute;top:0;left:0;display:block;">' +
  '<circle cx="379.54" cy="50" r="14.49"/><circle cx="250.6" cy="51.45" r="15.1"/>' +
  '<circle cx="378.42" cy="121.64" r="28.65"/><circle cx="250.62" cy="121.8" r="28.65"/>' +
  '<circle cx="122.32" cy="121.83" r="28.65"/><circle cx="506.56" cy="122.38" r="28.65"/>' +
  '<circle cx="385.8" cy="242.42" r="50.26"/><circle cx="244.16" cy="242.67" r="50.26"/>' +
  '<circle cx="579.54" cy="250" r="14.49"/><circle cx="507.19" cy="250.41" r="29.6"/>' +
  '<circle cx="51.09" cy="250.5" r="14.49"/><circle cx="122.98" cy="250.83" r="29.6"/>' +
  '<circle cx="506.63" cy="377.52" r="29.6"/><circle cx="578.37" cy="377.78" r="14.49"/>' +
  '<circle cx="122.54" cy="377.89" r="29.6"/><circle cx="50" cy="378.34" r="14.49"/>' +
  '<circle cx="385.78" cy="385.72" r="50.26"/><circle cx="244.22" cy="385.89" r="50.26"/>' +
  '<circle cx="123.16" cy="506.26" r="28.65"/><circle cx="379.04" cy="506.85" r="28.65"/>' +
  '<circle cx="507.31" cy="506.91" r="28.65"/><circle cx="251.27" cy="507.02" r="28.65"/>' +
  '<circle cx="378.9" cy="576.86" r="15.1"/><circle cx="250" cy="578.34" r="14.49"/>' +
  '</svg>' +
  '</td>';
